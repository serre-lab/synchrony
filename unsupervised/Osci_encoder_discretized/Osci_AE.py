...
parser.add_argument('--exp_name', type=str, default='Osci_MNIST_linear_discretized_debug')
...
def train(epoch):
    ...
    for batch_idx, (data, _) in enumerate(train_loader):
        ...
        model.fcdiscrete.weight.backward(gradient=model.fcdiscrete.weight.grad)
