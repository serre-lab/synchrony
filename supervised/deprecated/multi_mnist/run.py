...
parser.add_argument('-n', '--num_textures', type=int, default=3)
parser.add_argument('-sp', '--save-path', type=str, help='where to save data', default='new_experiment')
parser.add_argument('-i', '--interactive', type=bool, help='Turn on interactive plotting.', default=False)
...
displayer = kv.displayer(interactive=args.interactive)
...
for epoch in range(train_epochs):
    ...
    for step in tqdm(range(training_order.shape[0])):
